...
<section class="boxBody">
    <div>
        <a href="<%=GlobalInfo.URL_PROYECTO%>" class="logoTxt">
    ...
    <form method="POST" action=<%=GlobalInfo.URL_SERVLET_LOGIN%>>
        ...
        <br/>
        <input type="text" id="userName" name="userName" placeholder="Nombre123" minlength="5" required/>
        <br/>
        <br/>
        <label for="userPassword">Contraseña</label>
        <br/>
        <input type="password" id="userPassword" name="userPassword" placeholder="Password" minlength="5" required/>
        <br/>
        <br/>

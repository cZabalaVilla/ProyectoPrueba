...
(
    ...
    CONSTRAINT `INCOME_ibfk_1` FOREIGN KEY (`budgetId`) REFERENCES `BUDGET` (`budgetId`),
    CONSTRAINT `INCOME_ibfk_2` FOREIGN KEY (`categoryId`) REFERENCES `CATEGORY` (`categoryId`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 3
